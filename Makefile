...
TA_improved_bardelta : TA_shrink_bardelta_update.c TA_shrink_deltabardelta.c TA_common.c TA_common.h
	gcc $(gccflags) -o TA_improved_bardelta TA_shrink_bardelta_update.c TA_shrink_deltabardelta.c TA_common.c -lm
